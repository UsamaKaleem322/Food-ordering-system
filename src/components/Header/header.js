    ...
    <Container fluid >
      <Row className='topRow px-md-5'>
        <Col xs={6} className='left-column'>
          ...
          <p>My Account</p>
          <p>Whishlist</p>
          <p className='text'>We deliver to you every day from <span>7:00 to 23:00</span></p>
        </Col>
      ...
      <Row className='middleRow'>
        <Navbar collapseOnSelect expand="lg" className="bg-body-tertiary px-md-5">
          <Container fluid >
            <Navbar.Brand className='title'> <span>Grocery</span> Store</Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className='me-auto'>
                <div className='location'><MdOutlineLocationOn className='icon mx-1'
                /> Deliver to all</div>
              </Nav>
              <Nav className='mx-auto'>
              <form className='d-flex'>
                  <input type='text' className='form-control mx-3' placeholder='Product & Categories...' />
                  <button className='btn btn-outline btn-light'><IoSearchSharp className='icon' /></button>
                </form>
              </Nav>
              <Nav className='ms-auto right'>
                <div className=' text-center '>
                  <RiAccountPinCircleFill className='icon' /><br />
                  <p>Account</p>
                </div>
