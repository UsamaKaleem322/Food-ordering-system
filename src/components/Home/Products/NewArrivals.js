    ...
    <div className='products my-3 mx-0'>
      <div className='row review' style={{width:'320px'}}>
        <div  className='col-4'>
         ...
         <p className='text'>Good quality product can only be found in good stores</p>
         <div className='first'>
          <p>Only This Week</p>
          <h4>Where flavor meets<br/> affordability.</h4>
          <span>Only this week.<br/> Don't miss...</span><br/>
        </div>
      </div>
